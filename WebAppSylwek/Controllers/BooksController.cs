...
namespace WebAppSylwek.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(BiblioDbContext context)
        {
            _context = context;
        }
            ...
            ViewData["GenreId"] = new SelectList(new[]
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Author,GenreId,NumberInStock")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Author,GenreId,NumberInStock")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
